...
If the file contains modified peptides - the modified peptide is treated as an another peptide and has its unique ID. The values are calculated using measurements for the peptide with modification.
If there is both unmodified and modified version of the peptide, they are treated as different peptides.
