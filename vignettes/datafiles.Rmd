...
Aggregation of values is inspired by an already published solution [@keppel_mapping_2015]. This process can be conducted of any deuterium uptake variation - fractional or absolute, with theoretical or experimental control, single-state or differential. 
