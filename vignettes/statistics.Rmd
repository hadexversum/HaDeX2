...
Hybrid testing [@hageman_reliable_2019] is a combination of two statistical approaches to ensure that the difference between two biological states is statistically significant. The difference is significant if two tests simultaneously claim the significance.
