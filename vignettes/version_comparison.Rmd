...
microbenchmark(
  ...
  dat <- HaDeX::read_hdx("C:\\\\Users\\\\User\\\\Desktop\\\\alpha dane\\\\alpha_cut.csv")
...
microbenchmark(
  ...
  plt_uc <- dat %>% 
    HaDeX::calculate_peptide_kinetics(sequence = "GFGDLKSPAGL",      
                               state = "Alpha_KSCN", 
                               start = 1, end = 11, 
...
microbenchmark(
  ...
  create_state_comparison_dataset(dat = dat, 
...
microbenchmark(
  ...
  diff_uptake_dat <- create_diff_uptake_dataset(dat, 
                                                state_1 = "Alpha_KSCN",      
                                                state_2 = "ALPHA_Gamma", 
                                                time_0 = 0, time_100 = 1440) %>%   plot_differential(diff_uptake_dat = .,      
                                 time_t = 1, 
                                 theoretical = FALSE, 
                                 fractional = TRUE, 
