...
We can start by looking at deuterium uptake per peptide/time point. The first plot generated is the Deuterium uptake plot (Figure \@ref{fig:fig_d_uptake}). This shows replicate-averaged deuterium uptake values per peptide, for all selected states, at a given time point. It provides a good starting point to inspect the data, and verify no peptide deuterium uptake exceeds the maximal uptake control uptake. 
